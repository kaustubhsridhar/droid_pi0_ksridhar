...
class FrankaEnv:
    ...
    def observe(self):
        ...
        # Create Occulus observation dictionary with robot_state wrapper
        obs_occulus = {
            "robot_state": {
                "cartesian_position": np.concatenate([proprio.eef_pos, proprio.eef_euler]),
                "gripper_position": proprio.gripper_open
            }
        }

        return obs, obs_occulus
